      ...
      <ModalHeader
        ...
        cardTitle={
          <span className="text-base sm:text-xl">
            {year}년 {month}월 일기 미리보기
          </span>
        }
        cardDescription={
          <span className="text-sm sm:text-base">PDF로 저장하기 전에 내용을 확인할 수 있어요.</span>
        }
      />
      <ModalBody className="max-w-3xl max-h-[70vh] flex flex-col">
        ...
        <div className="mt-3 flex justify-between items-center">
          ...
          <div className="flex gap-2">
            <ClientButton type="button" variant="roundedRed" label="닫기" onClick={onClose} />
            <ClientButton
              type="button"
