...
import CanvasContainer from '@/features/diary-detail/components/canvas-container'
import WriteButton from '@/features/diary-detail/components/write-button'
...
import { updateDiary } from '../api/update-diary.api'
    ...
    <form onSubmit={handleSubmit}>
      ...
      <div className="text-center mb-4">
        <span onClick={handleCancel} className="mr-2">
          <WriteButton label="취소" type="button" />
        </span>
